...
class OrderItemShape extends StatefulWidget {
  final OrderItem order;

  OrderItemShape(this.order);

  @override
  _OrderItemShapeState createState() => _OrderItemShapeState();
}

class _OrderItemShapeState extends State<OrderItemShape> {
  var _expanded=false;
  @override
